...
class UserProfile {
    ...
    public function getUserProfile() {
        ...
        $select_profile->execute([$this->userId]);
...
$fetch_profile = $userProfile->getUserProfile();
...
<section class="profile-container">
   ...
   <div class="profile">
      ...
      <a href="user_profile_delete.php" class="delete-btn">delete profile</a> <!-- Hinzugefügt: Delete-Button -->
